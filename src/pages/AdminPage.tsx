  ...
  return (
    <DashboardLayout title="Admin Dashboard" subtitle="Platform analytics and oversight (demo data)">
      ...
      <div className="mt-6 rounded-xl border border-accent-200 bg-accent-50 p-4">
        <p className="text-xs text-accent-800">All data shown is mock/demo data for illustration purposes. Real analytics will be connected when the backend is implemented.</p>
      </div>
    </DashboardLayout>
  );
}
