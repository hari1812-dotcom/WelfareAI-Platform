...
export function FindSchemesPage() {
  ...
  const [selectedCategory, setSelectedCategory] = useState<SchemeCategory | null>(categoryParam);
  ...
  return (
    <DashboardLayout title="Find Schemes" subtitle="Discover welfare schemes matched to your needs">
      {/* Search bar */}
      ...
      <div className="mb-3 flex items-center justify-between">
        <p className="text-sm text-gray-500">{filtered.length} scheme(s) found</p>
