        ...
        <div className="container-page relative py-16 lg:py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Button onClick={handleFindSchemes} size="lg" className="w-full sm:w-auto"><Search className="h-5 w-5" /> {t('findMySchemes')}</Button>
              <Button to="/schemes" variant="outline" size="lg" className="w-full sm:w-auto">{t('exploreSchemes')} <ArrowRight className="h-5 w-5" /></Button>
            </div>
            <div className="mt-4"><Button to="/assistant" variant="ghost" size="md"><Sparkles className="h-4 w-4 text-accent-500" /> {t('askAssistant')}</Button></div>
          </div>
          ...
          <div className="mx-auto mt-14 max-w-3xl">
            <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-card lg:p-8">
              ...
              <form onSubmit={handleFindSchemes} className="grid gap-4 sm:grid-cols-2">
                <div>
                  <label htmlFor="state" className="label-base"><MapPin className="mr-1 inline h-4 w-4" /> {t('location')}</label>
                ...
                <div>
                  <label htmlFor="age" className="label-base"><Calendar className="mr-1 inline h-4 w-4" /> {t('age')}</label>
                ...
                <div>
                  <label htmlFor="occupation" className="label-base"><Briefcase className="mr-1 inline h-4 w-4" /> {t('occupation')}</label>
                ...
                <div>
                  <label htmlFor="income" className="label-base"><Wallet className="mr-1 inline h-4 w-4" /> {t('annIncome')}</label>
                ...
                <div className="sm:col-span-2">
                  <Button type="submit" size="lg" className="w-full">{t('findMySchemes')} <ArrowRight className="h-5 w-5" /></Button>
                </div>
              </form>
              <p className="mt-4 flex items-center justify-center gap-1.5 text-center text-xs text-gray-400">
                <Lock className="h-3.5 w-3.5" /> {t('privacyNote')}
              </p>
            </div>
          </div>
        </div>
